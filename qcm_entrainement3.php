...
<body>
    ...
    <section id="question-1" class="question">
        ...
        <form id="form-1"> 
            <label><input type="radio" name="q1" value="1" onclick="enableNext(1)">De définir les livrables et l’objectif du Sprintt</label><br>
            <label><input type="radio" name="q1" value="1" onclick="enableNext(1)">De résoudre les problèmes techniques du projet</label><br>
            <label><input type="radio" name="q1" value="1" onclick="enableNext(1)">D’évaluer les performances de l’équipe</label><br>
            <label><input type="radio" name="q1" value="1" onclick="enableNext(1)">D’établir un rapport final pour les parties prenantes</label>
        </form>
    ...
    <section id="question-2" class="question hidden">
        ...
        <form id="form-2">
            ...
            <label><input type="radio" name="q2" value="0" onclick="enableNext(2)">L’Équipe de Développementt</label><br>
    ...
    <section id="question-4" class="question hidden">
        ...
        <form id="form-4">
            <label><input type="radio" name="q4" value="0" onclick="enableNext(4)">Le Product Owner uniquement</label><br>
            <label><input type="radio" name="q4" value="0" onclick="enableNext(4)">Le Product Owner, le Scrum Master, et l’Équipe de Développement</label><br>
            <label><input type="radio" name="q4" value="0" onclick="enableNext(4)">Le Scrum Master et l’Équipe de Développement</label><br>
            <label><input type="radio" name="q4" value="0" onclick="enableNext(4)">Les parties prenantes externes uniquement</label>
        </form>
    ...
    <section id="question-5" class="question hidden">
        ...
        <form id="form-5">
            <label><input type="radio" name="q5" value="0" onclick="enableNext(5)">Les tâches sont assignées par le Scrum Master</label><br>
            <label><input type="radio" name="q5" value="0" onclick="enableNext(5)">L’équipe détermine elle-même comment accomplir son travail</label><br>
            <label><input type="radio" name="q5" value="0" onclick="enableNext(5)">L’équipe n’a pas besoin de priorités définies</label><br>
            <label><input type="radio" name="q5" value="0" onclick="enableNext(5)">Les décisions sont prises par vote majoritaire</label>
        </form>
    ...
    <section id="question-6" class="question hidden">
        ...
        <form id="form-6">
            <label><input type="radio" name="q6" value="1" onclick="enableNext(6)">La capacité de l’équipe à s’améliorer à chaque Sprint</label><br>
            <label><input type="radio" name="q6" value="0" onclick="enableNext(6)">La supervision étroite par le Scrum Master"</label><br>
            <label><input type="radio" name="q6" value="1" onclick="enableNext(6)">L’absence de réunions inutiles</label><br>
            <label><input type="radio" name="q6" value="0" onclick="enableNext(6)">Le remplacement fréquent des membres de l’équipe</label>
        </form>
    ...
    <section id="question-8" class="question hidden">
        ...
        <form id="form-8">
            <label><input type="radio" name="q8" value="1" onclick="enableNext(8)">Planning Poker</label><br>
            <label><input type="radio" name="q8" value="0" onclick="enableNext(8)">Diagrammes de Gantt</label><br>
            <label><input type="radio" name="q8" value="0" onclick="enableNext(8)">Analyse SWOT</label><br>
            <label><input type="radio" name="q8" value="0" onclick="enableNext(8)">Matrice de priorisation</label>
        </form>
    ...
    <section id="question-10" class="question hidden">
        ...
        <form id="form-10">
            <label><input type="radio" name="q10" value="0" onclick="enableNext(10)">La réduction des réunions</label><br>
            <label><input type="radio" name="q10" value="0" onclick="enableNext(10)">L’évitement des conflits internes</label><br>
            <label><input type="radio" name="q10" value="0" onclick="enableNext(10)">La suppression des rapports écrits</label><br>
            <label><input type="radio" name="q10" value="1" onclick="enableNext(10)">La transparence et la fluidité des échanges</label>
        </form>
